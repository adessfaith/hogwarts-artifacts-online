...
public class ArtifactController {
    ...
    public Result findAllArtifacts() {
        ...
        //Convert a list of all artifacts to ArtifactDtos

        List<ArtifactDto> artifactDtos = foundArtifacts.stream().map(foundArtifact->this.artifactToArtifactDtoConverter.convert(foundArtifact))
